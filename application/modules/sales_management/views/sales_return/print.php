...
<html>
    ...
    <body>
        <table width="100%" align="center" border="0" cellpadding="0"
            ...
            <tr>
                <td align="center"><span style="font-size: 18px; font-weight: bold">SALES RETURN</span><br /></td>
            </tr>
            <tr>
                            ...
                            <td width=50%>
                                <table width="100%" border=0>
                                    <tr>
                                        ...
                                        <td width="1%">:</td>
                                        <td width="74%"><?php echo date("j M, Y, G:i ")?></td>
                                    </tr>
                                    <tr>
                                        <td width="25%"><strong>Periode</strong></td>
                                        <td width="1%">:</td>
                                        <td width="74%"><?php echo date("j M, Y",strtotime($start_date))?> <strong> to </strong>
                                        <?php echo date("j M, Y",strtotime($end_date))?></td>
                                    </tr>
                                </table>
                            </td>
                        <tr>
...
//                             print_r($item);
                            foreach ($item as $result) {
                                ...
                                <tr>
                                    ...
                                    <td style="border-right: 1px #000 solid;" align="center"><?php echo $result->sku ?>&nbsp;</td>
                                    ...
                                    <td style="border-right: 1px #000 solid;" align="center"><?php echo $result->uom_code ?>&nbsp;</td>
